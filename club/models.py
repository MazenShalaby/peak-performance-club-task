...
class GymClass(CreatedUpdatedTimeStamp):
    ...
    trainer = models.ForeignKey(Trainer, on_delete=models.SET_NULL, null=True, blank=True, default="No trainer added yet for this gym class", related_name="gymclass_trainer")
